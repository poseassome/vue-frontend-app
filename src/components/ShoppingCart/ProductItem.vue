  ...
  <div data-test="cart-item">
    ...
    <div class="w-full flex justify-between text-left items-center">
      <p class="rounded-full overflow-hidden w-24 h-24">
        ...
        class="h-full" data-test="cart-item-img">
      </p>
      <div class="w-4/6">
        <p class="font-bold" data-test="cart-item-name">{{ productmenu.product.nameKr }}</p>
        <p class="text-sm">
          {{ productmenu.product.nameEng }} | {{ productmenu.cupSize.name }}
        </p>
        <p class="text-xs text-neutral-500" data-test="cart-item-options"
